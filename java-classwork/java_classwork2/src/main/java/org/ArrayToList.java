...
public class ArrayToList {
    ...
    public void convert(String[] a) {
        for (int pos =0; pos < a.length; pos++){
            ...
            System.out.println(STR."I have added the string: \{a[pos]} at the index:" + pos);
        }
    ...
    public void replace(int idx) {
        ...
        //what we are doing here is getting the actual string that is int the
        ...
        System.out.println(STR."i have replaced the string:\{value} with a null string");
